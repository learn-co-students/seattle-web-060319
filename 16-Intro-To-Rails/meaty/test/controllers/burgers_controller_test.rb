...
class BurgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create burger" do
    assert_difference('Burger.count') do
      post burgers_url, params: { burger: { calories: @burger.calories, meat: @burger.meat, name: @burger.name, tasty: @burger.tasty } }
    end
  ...
  test "should update burger" do
    patch burger_url(@burger), params: { burger: { calories: @burger.calories, meat: @burger.meat, name: @burger.name, tasty: @burger.tasty } }
